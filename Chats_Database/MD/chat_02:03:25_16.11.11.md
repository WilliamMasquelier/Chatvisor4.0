...
Analyze how Lakwerk is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Founded by Jessica Scholten, discussed in relation to gellak application and nail care.

Determine if the portrayal of Lakwerk is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Lakwerk in this article on a scale from -5 to 5, where:

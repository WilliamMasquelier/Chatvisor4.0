...
Analyze how Clean Energy Regulator (CER) is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Industry watchdog responsible for managing carbon credit schemes, mentioned in relation to conflicts of interest.

Determine if the portrayal of Clean Energy Regulator (CER) is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Clean Energy Regulator (CER) in this article on a scale from -5 to 5, where:

...
Analyze how PGE Polska Grupa Energetyczna is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Partner in the offshore wind farm project in the Baltic Sea, involved in financing and project execution.

Determine if the portrayal of PGE Polska Grupa Energetyczna is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards PGE Polska Grupa Energetyczna in this article on a scale from -5 to 5, where:

...
Analyze how Greenpeace is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Campaign group that challenged the government's decision to greenlight oil and gas projects.

Determine if the portrayal of Greenpeace is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Greenpeace in this article on a scale from -5 to 5, where:

...
Analyze how Southern California Edison is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Utility in California adding energy storage and solar-plus-batteries to replace natural gas power plants.

Determine if the portrayal of Southern California Edison is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Southern California Edison in this article on a scale from -5 to 5, where:

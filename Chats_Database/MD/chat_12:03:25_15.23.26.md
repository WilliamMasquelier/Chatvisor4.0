...
Analyze how Chandra Asri is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Mentioned as part of a joint venture that includes Glencore, which acquired Shell's chemicals park in Singapore.

Determine if Chandra Asri's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Chandra Asri in this article on a scale from -5 to 5, where:
...
Person Context: Mentioned as part of a joint venture that includes Glencore, which acquired Shell's chemicals park in Singapore.

...
Analyze how Inglot is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Brand of nail products mentioned for providing nail polishes that are free from harmful chemicals.

Determine if the portrayal of Inglot is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Inglot in this article on a scale from -5 to 5, where:

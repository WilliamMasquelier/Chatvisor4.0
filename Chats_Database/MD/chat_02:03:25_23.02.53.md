...
Analyze how Raiffeisen is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in the context of its legal issues in Russia and its involvement with Strabag.

Determine if the portrayal of Raiffeisen is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Raiffeisen in this article on a scale from -5 to 5, where:

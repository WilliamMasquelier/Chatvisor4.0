...
Analyze how Telenor is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A telecommunications company in Norway where Trond Westlie previously managed finances.

Determine if the portrayal of Telenor is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Telenor in this article on a scale from -5 to 5, where:

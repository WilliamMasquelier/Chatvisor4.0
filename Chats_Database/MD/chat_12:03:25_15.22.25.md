...
Analyze how Ithaca Energy is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Co-owner of the Rosebank oilfield alongside Equinor.

Determine if the portrayal of Ithaca Energy is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Ithaca Energy in this article on a scale from -5 to 5, where:

...
Analyze how Hochschule Bremerhaven is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Educational institution where Professor Holger Lange works, discussing wind energy technology.

Determine if the portrayal of Hochschule Bremerhaven is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Hochschule Bremerhaven in this article on a scale from -5 to 5, where:

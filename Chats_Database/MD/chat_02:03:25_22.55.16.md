...
Analyze how Tata Steel is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in relation to government funding for workers affected by plant closures.

Determine if the portrayal of Tata Steel is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Tata Steel in this article on a scale from -5 to 5, where:

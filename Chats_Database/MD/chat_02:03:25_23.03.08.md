...
Analyze how Besi is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Another chipmaker mentioned as one of the biggest losers in the stock market.

Determine if the portrayal of Besi is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Besi in this article on a scale from -5 to 5, where:

...
Analyze how Schneider Electric is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Company teaming up with ENGIE North America on solar and battery systems in Texas to achieve renewable energy goals.

Determine if the portrayal of Schneider Electric is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Schneider Electric in this article on a scale from -5 to 5, where:

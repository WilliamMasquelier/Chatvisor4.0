...
Analyze how Ineos is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Petrochemical company that acquired oil & gas assets from Orsted.

Determine if the portrayal of Ineos is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Ineos in this article on a scale from -5 to 5, where:

...
Analyze how Cloud Software Group is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Parent company of Citrix, mentioned as having downsized operations in China.

Determine if the portrayal of Cloud Software Group is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Cloud Software Group in this article on a scale from -5 to 5, where:

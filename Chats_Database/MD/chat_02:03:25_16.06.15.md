...
**DESCRIPTION**: Warns about acrylate allergy related to artificial nails.

**ENTITY**: Clinique Dermatologie Gent  
**TYPE**: Medical Institution  
**DESCRIPTION**: Dermatology clinic where Dr. Griet Voet practices, providing insights on acrylate allergy.

**ENTITY**: Dermatologie Landegem  
**TYPE**: Medical Institution  
**DESCRIPTION**: Dermatology clinic where Dr. Sven Lanssens practices, discussing contact allergy.

**ENTITY**: Zeeman  
**TYPE**: Retail Company  
**DESCRIPTION**: Mentioned in the context of testing perfumes.

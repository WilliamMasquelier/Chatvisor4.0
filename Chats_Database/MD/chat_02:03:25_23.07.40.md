...
Analyze how Ireen Geerbex is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Expresses concerns about the potential failure of the tender and the need for government intervention.

Determine if Ireen Geerbex's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Ireen Geerbex in this article on a scale from -5 to 5, where:
...
Person Context: Expresses concerns about the potential failure of the tender and the need for government intervention.

...
Analyze how Sydbank is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Analyst mentioned in relation to Orsted's investment and capacity targets.

Determine if the portrayal of Sydbank is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Sydbank in this article on a scale from -5 to 5, where:

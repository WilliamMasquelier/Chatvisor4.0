...
Analyze how Veronika Scavnicka is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Shares her reasons for using gel nails and her current lack of negative experiences.

Determine if Veronika Scavnicka's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Veronika Scavnicka in this article on a scale from -5 to 5, where:
...
Person Context: Shares her reasons for using gel nails and her current lack of negative experiences.

...
Analyze how Aravindan Madasamy is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Worked on the smart irrigation system and highlighted its transformative impact on farming practices.

Determine if Aravindan Madasamy's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Aravindan Madasamy in this article on a scale from -5 to 5, where:
...
Person Context: Worked on the smart irrigation system and highlighted its transformative impact on farming practices.

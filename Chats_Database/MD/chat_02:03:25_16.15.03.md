...
Analyze how Twentse nagelstylisten is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Group of nail stylists in Twente who are mentioned in relation to the popularity and risks of gel nails.

Determine if the portrayal of Twentse nagelstylisten is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Twentse nagelstylisten in this article on a scale from -5 to 5, where:

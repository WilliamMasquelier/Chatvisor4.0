...
Analyze how Reserve Bank of Australia is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in relation to raising interest rates due to inflation driven by higher electricity bills linked to gas supply issues.

Determine if the portrayal of Reserve Bank of Australia is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Reserve Bank of Australia in this article on a scale from -5 to 5, where:

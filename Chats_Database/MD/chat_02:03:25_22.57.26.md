...
Analyze how Global Warming Policy Foundation is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Associated with the Renewable Energy Foundation, mentioned in the context of climate denial.

Determine if the portrayal of Global Warming Policy Foundation is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Global Warming Policy Foundation in this article on a scale from -5 to 5, where:

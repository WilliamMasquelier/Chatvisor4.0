...
Analyze how Cepsa is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed as a company undergoing transformation to become a leader in mobility and sustainable energy in Spain and Portugal.

Determine if the portrayal of Cepsa is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Cepsa in this article on a scale from -5 to 5, where:

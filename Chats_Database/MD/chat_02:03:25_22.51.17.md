...
Analyze how Akzo-Nobel is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in the context of a former employer of a technician who transitioned to Cargill.

Determine if the portrayal of Akzo-Nobel is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Akzo-Nobel in this article on a scale from -5 to 5, where:

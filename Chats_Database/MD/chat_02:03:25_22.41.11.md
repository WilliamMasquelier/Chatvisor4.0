...
**ENTITY**: Windpark Borssele 1 en 2  
**TYPE**: Wind Farm  
**DESCRIPTION**: Discussed as the location where Ørsted is using drones to transport safety boxes for the turbines.

**ENTITY**: Windpark Hornsea  
**TYPE**: Wind Farm  
**DESCRIPTION**: Mentioned as a previous site where Ørsted conducted a drone trial for transporting heavy loads.  

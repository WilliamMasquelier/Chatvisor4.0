...
Analyze how GM is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as an automobile manufacturer at risk due to proposed tariffs on imports from Canada and Mexico.

Determine if the portrayal of GM is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards GM in this article on a scale from -5 to 5, where:

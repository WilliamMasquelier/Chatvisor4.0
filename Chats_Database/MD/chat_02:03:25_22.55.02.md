...
Analyze how H&M is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Determine if the portrayal of H&M is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards H&M in this article on a scale from -5 to 5, where:

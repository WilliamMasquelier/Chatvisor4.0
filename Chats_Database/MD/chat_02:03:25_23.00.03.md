...
Analyze how Connor Teskey is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Quoted regarding Brookfield's investment in UK offshore wind and its support for decarbonisation objectives.

Determine if Connor Teskey's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Connor Teskey in this article on a scale from -5 to 5, where:
...
Person Context: Quoted regarding Brookfield's investment in UK offshore wind and its support for decarbonisation objectives.

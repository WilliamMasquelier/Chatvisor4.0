...
Analyze how Christopher Doleman is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Mentioned as providing insights on the barriers to LNG demand growth and the cost implications of LNG compared to coal.

Determine if Christopher Doleman's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Christopher Doleman in this article on a scale from -5 to 5, where:
...
Person Context: Mentioned as providing insights on the barriers to LNG demand growth and the cost implications of LNG compared to coal.

...
**TYPE**: Company  
**DESCRIPTION**: Discussed as one of the major companies involved in the expansion of wind farms, awarded contracts for new projects.

**ENTITY**: Iberdrola  
**TYPE**: Company  
**DESCRIPTION**: Mentioned as the parent company of ScottishPower, a key player in the renewable energy sector.

**ENTITY**: National Grid Electricity System Operator (ESO)  
**TYPE**: Government Agency  
**DESCRIPTION**: Responsible for calculating the budget impact of subsidies for offshore wind and other renewables.

**ENTITY**: Department for Energy Security and Net Zero  
**TYPE**: Government Agency  
**DESCRIPTION**: Provided a statement regarding the costs per household and the importance of renewable energy for UK energy security.  

**ENTITY**: Hornsea 3  
**TYPE**: Project  
**DESCRIPTION**: Referenced as a significant offshore wind project potentially becoming the world's largest wind farm.  

**ENTITY**: Hornsea 4  
**TYPE**: Project  
**DESCRIPTION**: Mentioned as another offshore wind project awarded a contract for delivery of renewable power.  

**ENTITY**: East Anglia Two  
**TYPE**: Project  
**DESCRIPTION**: Discussed as one of the large wind farms for which ScottishPower has been offered contracts.  

**ENTITY**: East Anglia Three  
**TYPE**: Project  
**DESCRIPTION**: Another large wind farm project awarded contracts to ScottishPower, allowed to move from previous contracts.  

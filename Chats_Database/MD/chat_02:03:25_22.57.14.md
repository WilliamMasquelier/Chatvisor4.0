...
Analyze how SIMEC is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Developer of the MeyGen 2 tidal stream project, which secured a new contract in the green energy auction.

Determine if the portrayal of SIMEC is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards SIMEC in this article on a scale from -5 to 5, where:

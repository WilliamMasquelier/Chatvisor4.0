...
Analyze how Cheniere is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Referenced as a company in the gas sector that may be affected by changes in energy policy.

Determine if the portrayal of Cheniere is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Cheniere in this article on a scale from -5 to 5, where:

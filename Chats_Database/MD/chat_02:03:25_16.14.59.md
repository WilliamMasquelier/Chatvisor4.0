...
Analyze how MST is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Dermatologist from MST warns about the risks associated with gel nails and the increase in acrylate allergies.

Determine if the portrayal of MST is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards MST in this article on a scale from -5 to 5, where:

...
Analyze how ExxonMobil is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in the context of potential benefits from new energy policies under Trump.

Determine if the portrayal of ExxonMobil is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards ExxonMobil in this article on a scale from -5 to 5, where:

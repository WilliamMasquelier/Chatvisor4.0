...
Analyze how Glennmont Partners is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Partner in the "Gode Wind 3" offshore wind project.

Determine if the portrayal of Glennmont Partners is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Glennmont Partners in this article on a scale from -5 to 5, where:

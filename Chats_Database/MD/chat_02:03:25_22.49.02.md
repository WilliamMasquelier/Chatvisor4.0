...
Analyze how Veon is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A telecommunications company in the Netherlands where Trond Westlie previously managed finances.

Determine if the portrayal of Veon is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Veon in this article on a scale from -5 to 5, where:

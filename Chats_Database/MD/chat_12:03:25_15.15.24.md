...
Analyze how Fatih Birol is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Stated the need for a transition to clean energy and criticized the fossil fuel industry's claims.

Determine if Fatih Birol's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Fatih Birol in this article on a scale from -5 to 5, where:
...
Person Context: Stated the need for a transition to clean energy and criticized the fossil fuel industry's claims.

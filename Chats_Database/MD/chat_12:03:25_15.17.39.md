...
Analyze how Matt Halliday is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Agreed with Robert Spurway on the necessity of appropriate policy for the biofuel sector.

Determine if Matt Halliday's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Matt Halliday in this article on a scale from -5 to 5, where:
...
Person Context: Agreed with Robert Spurway on the necessity of appropriate policy for the biofuel sector.

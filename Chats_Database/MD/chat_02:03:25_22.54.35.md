...
Analyze how Windpark Borssele 1 en 2 is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed as the location where Ørsted is using drones to transport safety boxes for the turbines.

Determine if the portrayal of Windpark Borssele 1 en 2 is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Windpark Borssele 1 en 2 in this article on a scale from -5 to 5, where:

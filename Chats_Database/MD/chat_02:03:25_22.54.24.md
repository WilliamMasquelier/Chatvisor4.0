...
Analyze how Protect Our Coast-NJ is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A vocal group opposing offshore wind, mentioned in the context of the Nantucket incident.

Determine if the portrayal of Protect Our Coast-NJ is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Protect Our Coast-NJ in this article on a scale from -5 to 5, where:

...
Analyze how Labour government is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Referenced in relation to the goal of quadrupling the UK’s offshore wind capacity.

Determine if the portrayal of Labour government is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Labour government in this article on a scale from -5 to 5, where:

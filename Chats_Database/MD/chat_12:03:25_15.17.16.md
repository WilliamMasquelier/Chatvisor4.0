...
Analyze how Australian National University is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in relation to demographic insights and workforce power in Canberra.

Determine if the portrayal of Australian National University is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Australian National University in this article on a scale from -5 to 5, where:

...
Analyze how Copenhagen Infrastructure Partners is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Part of the joint venture that operates Vineyard Wind.

Determine if the portrayal of Copenhagen Infrastructure Partners is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Copenhagen Infrastructure Partners in this article on a scale from -5 to 5, where:

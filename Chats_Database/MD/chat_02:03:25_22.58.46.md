...
Analyze how Green Oceans is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Sued the federal government over permits granted for offshore wind projects in Rhode Island.

Determine if the portrayal of Green Oceans is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Green Oceans in this article on a scale from -5 to 5, where:

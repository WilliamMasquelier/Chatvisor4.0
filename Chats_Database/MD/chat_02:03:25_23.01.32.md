...
Analyze how Petrobras is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as a Brazilian oil company involved in emissions discussions.

Determine if the portrayal of Petrobras is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Petrobras in this article on a scale from -5 to 5, where:

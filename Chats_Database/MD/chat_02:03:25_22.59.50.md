...
Analyze how Westinghouse is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Global nuclear business with stakes owned by Brookfield, including the Springfields site in Lancashire.

Determine if the portrayal of Westinghouse is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Westinghouse in this article on a scale from -5 to 5, where:

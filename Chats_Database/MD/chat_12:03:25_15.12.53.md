...
**ENTITY**: Clean Energy Council  
**TYPE**: NGO  
**DESCRIPTION**: Represents major renewable energy developers and discusses environmental and planning rules for wind farm development.

**ENTITY**: ERM Power  
**TYPE**: Company  
**DESCRIPTION**: An electricity retailer owned by Shell that sells to businesses.

**ENTITY**: Powershop  
**TYPE**: Company  
**DESCRIPTION**: A household energy retailer owned by Shell.

**ENTITY**: WestWind Energy  
**TYPE**: Company  
**DESCRIPTION**: A renewable energy developer in which Shell has a 49% interest.

**ENTITY**: Santos  
**TYPE**: Company  
**DESCRIPTION**: Mentioned in relation to the Barossa gas project and its litigation over Indigenous consultation.

**ENTITY**: Woodside Energy  
**TYPE**: Company  
**DESCRIPTION**: Mentioned in relation to the Scarborough LNG project and its involvement in the energy sector.

**ENTITY**: Chevron  
**TYPE**: Company  
**DESCRIPTION**: Mentioned in relation to its Gorgon LNG venture, in which Shell has a stake.  

**ENTITY**: Queensland Curtis LNG  
**TYPE**: Project  
**DESCRIPTION**: A large gas export project owned by Shell in Gladstone, Australia.  

**ENTITY**: Prelude LNG  
**TYPE**: Project  
**DESCRIPTION**: A floating LNG plant owned by Shell, mentioned in the context of gas supply.  

**ENTITY**: Crux LNG  
**TYPE**: Project  
**DESCRIPTION**: A Shell project in Western Australia that faced delays due to Indigenous consultation issues.  

**ENTITY**: Gangarri Solar Farm  
**TYPE**: Project  
**DESCRIPTION**: A solar farm in Queensland that is part of Shell's clean energy portfolio.  

**ENTITY**: Rangebank Battery  
**TYPE**: Project  
**DESCRIPTION**: A battery project south-east of Melbourne that is part of Shell's renewable generation and storage efforts.  

**ENTITY**: Wallerawang Battery  
**TYPE**: Project  
**DESCRIPTION**: A big battery project in NSW that is part of Shell's pipeline of renewable projects.  

**ENTITY**: Wheatbelt Storage Project  
**TYPE**: Project  
**DESCRIPTION**: A smaller storage project in WA's Wheatbelt region that is part of Shell's renewable energy pipeline.  

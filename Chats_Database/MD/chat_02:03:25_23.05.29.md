...
Analyze how US Government is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Referenced in relation to Donald Trump's executive order suspending new leases for offshore wind.

Determine if the portrayal of US Government is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards US Government in this article on a scale from -5 to 5, where:

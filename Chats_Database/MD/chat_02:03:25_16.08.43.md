...
**PERSON**: Thera Strietman  
**ROLE**: CEO of Pink Gellac  
**CONTEXT**: Provides advice on gellak manicure techniques and the importance of using products from the same brand for optimal results.

**PERSON**: Kate Middleton  
**ROLE**: Public figure  
**CONTEXT**: Mentioned in relation to a beauty product tested by the beauty editor, described as "botox in a flesje." 

**PERSON**: Thomas Rustemeyer  
**ROLE**: Dermatologist and allergologist  
**CONTEXT**: Discusses the risks of acrylate allergies related to gellak and the conditions under which they can develop.  

...
Analyze how MSCI Global Alternative Energy Index is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned regarding the performance of alternative energy companies.

Determine if the portrayal of MSCI Global Alternative Energy Index is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards MSCI Global Alternative Energy Index in this article on a scale from -5 to 5, where:

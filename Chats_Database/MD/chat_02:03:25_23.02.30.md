...
Analyze how Fugro is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed as a company that experienced a significant decline in stock due to challenges in the United States.

Determine if the portrayal of Fugro is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Fugro in this article on a scale from -5 to 5, where:

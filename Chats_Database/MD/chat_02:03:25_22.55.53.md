...
Analyze how Jake Finney is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Commented on the UK economy's performance and future expectations based on GDP data.

Determine if Jake Finney's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Jake Finney in this article on a scale from -5 to 5, where:
...
Person Context: Commented on the UK economy's performance and future expectations based on GDP data.

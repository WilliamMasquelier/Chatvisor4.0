...
Analyze how Inpex is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Company involved in the carbon offsets market, mentioned as a registrant of carbon projects.

Determine if the portrayal of Inpex is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Inpex in this article on a scale from -5 to 5, where:

...
Analyze how Cavitt Randall is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Appointed as the next CEO of Arena Group Holdings and previously served as CEO of MBX Clearing.

Determine if Cavitt Randall's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Cavitt Randall in this article on a scale from -5 to 5, where:
...
Person Context: Appointed as the next CEO of Arena Group Holdings and previously served as CEO of MBX Clearing.

...
Analyze how IJmuiden Ver is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Name of the previous tender for offshore wind parks that had low participation.

Determine if the portrayal of IJmuiden Ver is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards IJmuiden Ver in this article on a scale from -5 to 5, where:

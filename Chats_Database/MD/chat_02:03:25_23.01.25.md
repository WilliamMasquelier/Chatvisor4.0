...
Analyze how Carbon Tracker is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Cited for its analysis on companies' alignment with climate goals.

Determine if the portrayal of Carbon Tracker is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Carbon Tracker in this article on a scale from -5 to 5, where:

...
Analyze how AllergyCertified is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in relation to testing beauty products for allergens and harmful substances.

Determine if the portrayal of AllergyCertified is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards AllergyCertified in this article on a scale from -5 to 5, where:

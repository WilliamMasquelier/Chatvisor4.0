...
Analyze how Intel Corporation is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Announced plans to slash 15,000 jobs due to sluggish sales.

Determine if the portrayal of Intel Corporation is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Intel Corporation in this article on a scale from -5 to 5, where:

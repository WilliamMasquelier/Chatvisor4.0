...
Analyze how Marius Kloppers is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Acknowledged by Keating for his role in changing contract pricing for iron ore exports.

Determine if Marius Kloppers's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Marius Kloppers in this article on a scale from -5 to 5, where:
...
Person Context: Acknowledged by Keating for his role in changing contract pricing for iron ore exports.

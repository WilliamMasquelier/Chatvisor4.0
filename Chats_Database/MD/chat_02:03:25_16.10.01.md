...
Analyze how Kruidvat is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in the context of testing perfumes.

Determine if the portrayal of Kruidvat is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Kruidvat in this article on a scale from -5 to 5, where:

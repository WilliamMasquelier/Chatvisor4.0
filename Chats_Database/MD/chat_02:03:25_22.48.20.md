...
Analyze how Energie & Management is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: The source of the article discussing Orsted's financial losses and operational changes.

Determine if the portrayal of Energie & Management is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Energie & Management in this article on a scale from -5 to 5, where:

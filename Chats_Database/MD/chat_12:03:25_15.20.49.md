...
Analyze how Powershop is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A household energy retailer owned by Shell.

Determine if the portrayal of Powershop is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Powershop in this article on a scale from -5 to 5, where:

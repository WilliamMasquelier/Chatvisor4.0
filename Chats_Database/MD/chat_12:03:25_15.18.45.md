...
Analyze how Charles Liang is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discussed as the biggest winner on a percentage basis in relation to the AI boom.

Determine if Charles Liang's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Charles Liang in this article on a scale from -5 to 5, where:
...
Person Context: Discussed as the biggest winner on a percentage basis in relation to the AI boom.

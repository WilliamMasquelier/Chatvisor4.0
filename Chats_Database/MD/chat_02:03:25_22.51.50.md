...
Analyze how Masdar is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Associated with the "Baltic Eagle" offshore wind park.

Determine if the portrayal of Masdar is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Masdar in this article on a scale from -5 to 5, where:

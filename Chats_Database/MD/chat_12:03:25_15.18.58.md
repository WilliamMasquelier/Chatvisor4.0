...
Analyze how Deepesh Banerji is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discusses the effectiveness of AI in rostering and employee engagement.

Determine if Deepesh Banerji's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Deepesh Banerji in this article on a scale from -5 to 5, where:
...
Person Context: Discusses the effectiveness of AI in rostering and employee engagement.

...
Analyze how International Energy Agency (IEA) is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Analyzed the need for a transition to clean energy and its evolving stance on fossil fuels.

Determine if the portrayal of International Energy Agency (IEA) is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards International Energy Agency (IEA) in this article on a scale from -5 to 5, where:

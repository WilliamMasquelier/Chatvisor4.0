...
Analyze how Morrison Government is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Introduced new laws to protect taxpayers from clean-up costs associated with abandoned oil and gas projects.

Determine if the portrayal of Morrison Government is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Morrison Government in this article on a scale from -5 to 5, where:

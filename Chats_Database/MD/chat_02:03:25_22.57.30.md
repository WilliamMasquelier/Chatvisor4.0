...
Analyze how Emma Pinchbeck is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Stated that the use of British-based green energy was "more important than ever" after recent cost surges.

Determine if Emma Pinchbeck's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Emma Pinchbeck in this article on a scale from -5 to 5, where:
...
Person Context: Stated that the use of British-based green energy was "more important than ever" after recent cost surges.

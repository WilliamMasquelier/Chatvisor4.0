...
Analyze how Melanie Perkins is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Listed by Keating as a notable entrepreneur.

Determine if Melanie Perkins's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Melanie Perkins in this article on a scale from -5 to 5, where:
...
Person Context: Listed by Keating as a notable entrepreneur.

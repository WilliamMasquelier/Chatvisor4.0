...
Analyze how ABP is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in relation to its divestment from fossil fuel investments and its strategy to focus on clean energy.

Determine if the portrayal of ABP is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards ABP in this article on a scale from -5 to 5, where:

...
Analyze how D.R. Horton is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A homebuilder that reported good earnings, leading to a rise in its stock price.

Determine if the portrayal of D.R. Horton is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards D.R. Horton in this article on a scale from -5 to 5, where:

...
Analyze how Institute for Energy Economics and Financial Analysis is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Provides analysis on energy economics, discussing barriers to LNG investment and the cost competitiveness of LNG versus coal.

Determine if the portrayal of Institute for Energy Economics and Financial Analysis is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Institute for Energy Economics and Financial Analysis in this article on a scale from -5 to 5, where:

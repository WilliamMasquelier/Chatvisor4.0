...
Analyze how Solaria is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as one of the renewable energy companies in the Spanish stock market showing slight gains.

Determine if the portrayal of Solaria is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Solaria in this article on a scale from -5 to 5, where:

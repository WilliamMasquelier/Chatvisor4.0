...
Analyze how Statoil is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Former name of Equinor, mentioned in the context of the company's history and rebranding.

Determine if the portrayal of Statoil is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Statoil in this article on a scale from -5 to 5, where:

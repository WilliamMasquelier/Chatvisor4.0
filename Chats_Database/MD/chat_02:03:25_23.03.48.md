...
Analyze how SPGlobal is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Referenced for its insights on the uncertain effects of tariffs on the automotive industry.

Determine if the portrayal of SPGlobal is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards SPGlobal in this article on a scale from -5 to 5, where:

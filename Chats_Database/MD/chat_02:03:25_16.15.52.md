...
Analyze how Indigo Nails is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as a brand used by a nail stylist who believes it contains fewer harmful substances.

Determine if the portrayal of Indigo Nails is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Indigo Nails in this article on a scale from -5 to 5, where:

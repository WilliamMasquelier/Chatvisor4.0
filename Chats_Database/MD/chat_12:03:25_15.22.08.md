...
Analyze how BP plc is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as a rival to Shell that has also scaled back climate objectives to focus more on oil and gas.

Determine if the portrayal of BP plc is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards BP plc in this article on a scale from -5 to 5, where:

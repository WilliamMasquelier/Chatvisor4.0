...
Analyze how Lotte is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Shares her personal experience with an allergic reaction caused by gellak.

Determine if Lotte's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Lotte in this article on a scale from -5 to 5, where:
...
Person Context: Shares her personal experience with an allergic reaction caused by gellak.

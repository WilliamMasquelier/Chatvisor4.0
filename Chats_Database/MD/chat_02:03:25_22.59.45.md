...
Analyze how Checkatrade is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Online trade directory owned by Brookfield, connecting homeowners with tradespeople.

Determine if the portrayal of Checkatrade is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Checkatrade in this article on a scale from -5 to 5, where:

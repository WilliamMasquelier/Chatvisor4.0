...
Analyze how Nordex is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as a manufacturer of wind turbines facing potential risks from regulatory changes.

Determine if the portrayal of Nordex is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Nordex in this article on a scale from -5 to 5, where:

...
Analyze how Wetenschappelijk Comité voor Consumentenveiligheid is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Cited in relation to a report on the safety of gel polish usage and potential allergies.

Determine if the portrayal of Wetenschappelijk Comité voor Consumentenveiligheid is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Wetenschappelijk Comité voor Consumentenveiligheid in this article on a scale from -5 to 5, where:

...
Analyze how Landesbetrieb Hessen-Forst is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: State agency responsible for forest management and land use planning in Hessen.

Determine if the portrayal of Landesbetrieb Hessen-Forst is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Landesbetrieb Hessen-Forst in this article on a scale from -5 to 5, where:

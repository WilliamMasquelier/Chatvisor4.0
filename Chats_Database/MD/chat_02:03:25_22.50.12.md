...
Analyze how Meta Platforms, Inc. is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Owner of Facebook, receiving power from Ørsted’s Eleven Mile Solar Center for its data center in Mesa, Arizona.

Determine if the portrayal of Meta Platforms, Inc. is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Meta Platforms, Inc. in this article on a scale from -5 to 5, where:

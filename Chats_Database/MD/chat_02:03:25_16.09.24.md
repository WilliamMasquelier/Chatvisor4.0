...
Analyze how Tilly Westerveld is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: She provides advice on how to deal with and prevent issues related to cuticles around nails.

Determine if Tilly Westerveld's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Tilly Westerveld in this article on a scale from -5 to 5, where:
...
Person Context: She provides advice on how to deal with and prevent issues related to cuticles around nails.

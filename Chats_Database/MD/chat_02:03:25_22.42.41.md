...
**TYPE**: Company  
**DESCRIPTION**: Discussed as a major player in the offshore wind sector, owned by Iberdrola, and involved in the recent renewable energy auction.

**ENTITY**: Iberdrola  
**TYPE**: Company  
**DESCRIPTION**: Mentioned as the parent company of ScottishPower, benefiting from profits from renewable energy projects.
...
**ENTITY**: Energy UK  
**TYPE**: NGO  
**DESCRIPTION**: Commented on the importance of the recent renewable energy auction for achieving clean power goals.

**ENTITY**: Renewable Energy Foundation  
**TYPE**: NGO  
**DESCRIPTION**: A charity that publishes data on the renewables sector, providing critical commentary on the government's energy spending.

**ENTITY**: Department for Energy Security and Net Zero  
**TYPE**: Government Agency  
**DESCRIPTION**: Provided a statement regarding the importance of renewable energy investments for UK energy security.

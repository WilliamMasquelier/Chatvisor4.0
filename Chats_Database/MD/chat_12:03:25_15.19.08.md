...
Analyze how Cisco Systems is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Not included as per the instruction to exclude Cisco.

Determine if the portrayal of Cisco Systems is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Cisco Systems in this article on a scale from -5 to 5, where:

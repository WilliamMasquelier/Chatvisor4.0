...
Analyze how Woodside Energy Carbon Services is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Subsidiary of Woodside, involved in carbon offset projects and owns multiple property titles for these initiatives.

Determine if the portrayal of Woodside Energy Carbon Services is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Woodside Energy Carbon Services in this article on a scale from -5 to 5, where:

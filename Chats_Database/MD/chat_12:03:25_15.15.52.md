...
Analyze how Hess Corp. is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as the target of an all-share acquisition by Chevron valued at $53 billion.

Determine if the portrayal of Hess Corp. is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Hess Corp. in this article on a scale from -5 to 5, where:

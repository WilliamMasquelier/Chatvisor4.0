...
Analyze how Queensland Curtis LNG is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A large gas export project owned by Shell in Gladstone, Australia.

Determine if the portrayal of Queensland Curtis LNG is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Queensland Curtis LNG in this article on a scale from -5 to 5, where:

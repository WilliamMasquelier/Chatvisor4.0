...
Analyze how MT Group is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: To build a CO2 capture facility for Ørsted.

Determine if the portrayal of MT Group is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards MT Group in this article on a scale from -5 to 5, where:

...
Analyze how State-Owned Assets Supervision and Administration Commission is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: The agency overseeing China's state-owned enterprises, which issued Document 79 requiring replacement of foreign software.

Determine if the portrayal of State-Owned Assets Supervision and Administration Commission is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards State-Owned Assets Supervision and Administration Commission in this article on a scale from -5 to 5, where:

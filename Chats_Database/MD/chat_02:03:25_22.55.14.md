...
Analyze how Rank Group PLC is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Reported a return to profit due to a rebound in London casinos.

Determine if the portrayal of Rank Group PLC is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Rank Group PLC in this article on a scale from -5 to 5, where:

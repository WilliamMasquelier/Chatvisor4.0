...
Analyze how David van der Bijl is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Mentioned as a key figure in Ørsted who supports the campaign to attract young technicians to Zeeland, emphasizing the importance of employee satisfaction.

Determine if David van der Bijl's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards David van der Bijl in this article on a scale from -5 to 5, where:
...
Person Context: Mentioned as a key figure in Ørsted who supports the campaign to attract young technicians to Zeeland, emphasizing the importance of employee satisfaction.

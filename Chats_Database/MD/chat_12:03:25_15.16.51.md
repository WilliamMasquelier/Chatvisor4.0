...
**ENTITY**: Morningstar  
**TYPE**: Company  
**DESCRIPTION**: Financial services firm where Shani Jayamanne works as a director and investment specialist.

**ENTITY**: Owen Analytics  
**TYPE**: Consulting Business  
**DESCRIPTION**: Consulting business run by Ashley Owen, who writes a newsletter about investing.

**ENTITY**: Vanguard  
**TYPE**: Investment Management Company  
**DESCRIPTION**: Company associated with founder John Bogle, known for advising on simple investment portfolios.

**ENTITY**: Orbis Investment Management  
**TYPE**: Investment Management Company  
**DESCRIPTION**: Company where Eric Marais works as an investment specialist, focusing on active management.

**ENTITY**: Yield Financial Planning  
**TYPE**: Financial Planning Firm  
**DESCRIPTION**: Firm where managing director James McFall advocates for an active investment approach.  

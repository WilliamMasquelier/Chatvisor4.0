...
Analyze how TD Bank is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Previous employer of ANZ's chief technology officer, mentioned in relation to his experience.

Determine if the portrayal of TD Bank is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards TD Bank in this article on a scale from -5 to 5, where:

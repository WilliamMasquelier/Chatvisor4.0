...
Analyze how East Anglia Three is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Another large wind farm project awarded contracts to ScottishPower, allowed to move from previous contracts.

Determine if the portrayal of East Anglia Three is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards East Anglia Three in this article on a scale from -5 to 5, where:

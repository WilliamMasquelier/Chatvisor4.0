...
Analyze how Starbucks Corp is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in relation to a large executive pay package for its new CEO.

Determine if the portrayal of Starbucks Corp is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Starbucks Corp in this article on a scale from -5 to 5, where:

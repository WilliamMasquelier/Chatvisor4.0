...
Analyze how Total is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Determine if the portrayal of Total is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Total in this article on a scale from -5 to 5, where:

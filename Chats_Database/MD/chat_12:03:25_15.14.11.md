...
Analyze how Intertanko is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Suggested that the Red Sea waterway should be avoided following recent attacks.

Determine if the portrayal of Intertanko is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Intertanko in this article on a scale from -5 to 5, where:

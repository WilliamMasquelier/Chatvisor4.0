...
Analyze how Oracle Corporation is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as a software provider losing ground in China due to local competition and government policies.

Determine if the portrayal of Oracle Corporation is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Oracle Corporation in this article on a scale from -5 to 5, where:

...
Analyze how United Nations is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Organization mentioned in the context of the COP29 summit discussing global warming.

Determine if the portrayal of United Nations is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards United Nations in this article on a scale from -5 to 5, where:

...
Analyze how SSE PLC is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Secured contracts under the UK's latest green energy allocation round and awarded a contract for its Cloiche Wind Farm.

Determine if the portrayal of SSE PLC is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards SSE PLC in this article on a scale from -5 to 5, where:

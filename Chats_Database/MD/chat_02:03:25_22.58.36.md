...
Analyze how Save LBI is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Filed a lawsuit claiming that the Atlantic Shores project would violate noise ordinances.

Determine if the portrayal of Save LBI is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Save LBI in this article on a scale from -5 to 5, where:

...
Analyze how OceanBase is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A database developed by Alibaba and Ant Group, noted for replacing Oracle databases in their operations.

Determine if the portrayal of OceanBase is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards OceanBase in this article on a scale from -5 to 5, where:

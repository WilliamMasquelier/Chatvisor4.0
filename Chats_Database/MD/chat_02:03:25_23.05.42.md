...
Analyze how Sunrise Wind is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: An offshore wind project facing delays related to supply chain issues, mentioned in the context of Ørsted's challenges.

Determine if the portrayal of Sunrise Wind is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Sunrise Wind in this article on a scale from -5 to 5, where:

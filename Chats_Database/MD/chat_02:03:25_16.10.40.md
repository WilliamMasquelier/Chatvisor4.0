...
Analyze how Arch Academy is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Provides training for nail stylists, mentioned in relation to professional nail care practices.

Determine if the portrayal of Arch Academy is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Arch Academy in this article on a scale from -5 to 5, where:

...
Analyze how VVD is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Political party that is part of the motion to address the challenges faced by market participants.

Determine if the portrayal of VVD is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards VVD in this article on a scale from -5 to 5, where:

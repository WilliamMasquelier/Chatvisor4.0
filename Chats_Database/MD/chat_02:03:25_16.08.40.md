...
**ENTITY**: Pink Gellac  
**TYPE**: Company  
**DESCRIPTION**: Discussed as a brand of gel nail polish and related products, with tips on using their complete set for a successful manicure.

**ENTITY**: Manucurist  
**TYPE**: Company  
**DESCRIPTION**: Mentioned in relation to their semi-permanent LED nail polish and starter kits for manicures.

**ENTITY**: PN Selfcare  
**TYPE**: Company  
**DESCRIPTION**: Referenced for their gellak starter kit and specific nail polish colors available for purchase.

**ENTITY**: Wetenschappelijk Comité voor Consumentenveiligheid  
**TYPE**: Government Agency  
**DESCRIPTION**: Cited in relation to a report on the safety of gel polish usage and potential allergies.

**ENTITY**: KRO-NCRV  
**TYPE**: Media Organization  
**DESCRIPTION**: Mentioned as the platform where a dermatologist discussed the risks of acrylate allergies related to gel polish.

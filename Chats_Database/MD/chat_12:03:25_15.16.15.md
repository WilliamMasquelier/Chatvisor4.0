...
Analyze how Inflation Reduction Act is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: U.S. legislation influencing investments in green technologies and the political context for tariffs on Chinese products.

Determine if the portrayal of Inflation Reduction Act is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Inflation Reduction Act in this article on a scale from -5 to 5, where:

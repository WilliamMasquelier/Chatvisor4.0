...
Analyze how Jim Goedhart is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Mentioned as a key player in the campaign, discussing the importance of collaboration to address the labor market challenges in Zeeland.

Determine if Jim Goedhart's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Jim Goedhart in this article on a scale from -5 to 5, where:
...
Person Context: Mentioned as a key player in the campaign, discussing the importance of collaboration to address the labor market challenges in Zeeland.

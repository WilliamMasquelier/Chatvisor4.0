...
Analyze how Goldman Sachs is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Became a strategic shareholder in Orsted when it was focused on oil and gas.

Determine if the portrayal of Goldman Sachs is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Goldman Sachs in this article on a scale from -5 to 5, where:

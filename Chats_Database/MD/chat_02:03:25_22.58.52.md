...
Analyze how Jason Ryan is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Quoted discussing the rigorous environmental reviews and permitting processes for offshore wind projects.

Determine if Jason Ryan's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Jason Ryan in this article on a scale from -5 to 5, where:
...
Person Context: Quoted discussing the rigorous environmental reviews and permitting processes for offshore wind projects.

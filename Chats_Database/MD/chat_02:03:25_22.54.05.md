...
Analyze how Jan De Nul Group is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Collaborated with Orsted for the installation of monopile foundations at Gode Wind 3.

Determine if the portrayal of Jan De Nul Group is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Jan De Nul Group in this article on a scale from -5 to 5, where:

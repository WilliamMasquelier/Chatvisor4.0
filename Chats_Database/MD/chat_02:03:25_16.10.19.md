...
Analyze how Néonail is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Manufacturer of vegan nail polishes mentioned as an alternative to traditional gel nails.

Determine if the portrayal of Néonail is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Néonail in this article on a scale from -5 to 5, where:

...
Analyze how Office for National Statistics is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Source of GDP data discussed in the article.

Determine if the portrayal of Office for National Statistics is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Office for National Statistics in this article on a scale from -5 to 5, where:

...
Analyze how Möller-Maersk is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A logistics company where Trond Westlie previously managed finances.

Determine if the portrayal of Möller-Maersk is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Möller-Maersk in this article on a scale from -5 to 5, where:

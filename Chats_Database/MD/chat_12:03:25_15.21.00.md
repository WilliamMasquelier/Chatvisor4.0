...
Analyze how Prelude LNG is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A floating LNG plant owned by Shell, mentioned in the context of gas supply.

Determine if the portrayal of Prelude LNG is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Prelude LNG in this article on a scale from -5 to 5, where:

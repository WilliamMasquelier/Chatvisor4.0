...
Analyze how BHP is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed as a major player in the resources sector and its historical significance in gas exploration.

Determine if the portrayal of BHP is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards BHP in this article on a scale from -5 to 5, where:

...
**DESCRIPTION**: Mentioned in relation to an open day event that resulted in financial implications for parents.

**ENTITY**: Megahome  
**TYPE**: Company  
**DESCRIPTION**: Discussed in the context of a significant bankruptcy affecting its owner.

**ENTITY**: Openbaar Ministerie  
**TYPE**: Government Agency  
**DESCRIPTION**: Involved in the investigation of a shooting incident related to a controversial businessman.

**ENTITY**: MST  
**TYPE**: Healthcare Institution  
**DESCRIPTION**: A dermatologist from this institution warns about health risks associated with gel nails. 

**ENTITY**: Netto Tank  
**TYPE**: Company  
**DESCRIPTION**: A gas station mentioned in relation to price increases aimed at reducing neighborhood disturbances. 

...
Analyze how Bernard Looney is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Announced BP's commitment to reach net zero by 2050 and was later moved on by the board.

Determine if Bernard Looney's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Bernard Looney in this article on a scale from -5 to 5, where:
...
Person Context: Announced BP's commitment to reach net zero by 2050 and was later moved on by the board.

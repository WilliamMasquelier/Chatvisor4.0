...
Analyze how Exxon is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Referenced as a US oil major with higher share market valuations compared to UK and European counterparts.

Determine if the portrayal of Exxon is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Exxon in this article on a scale from -5 to 5, where:

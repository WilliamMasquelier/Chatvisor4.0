...
Analyze how Canva is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as a company founded by Melanie Perkins and Cliff Obrecht, representing modern entrepreneurial success.

Determine if the portrayal of Canva is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Canva in this article on a scale from -5 to 5, where:

...
Analyze how Tsinghua Tongfang Co., Ltd. is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A state-owned tech manufacturer discussed in relation to replacing foreign-branded PCs with domestic alternatives.

Determine if the portrayal of Tsinghua Tongfang Co., Ltd. is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Tsinghua Tongfang Co., Ltd. in this article on a scale from -5 to 5, where:

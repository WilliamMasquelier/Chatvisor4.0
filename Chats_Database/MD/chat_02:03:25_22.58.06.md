...
Analyze how Scottish Power is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Part of the agreement for a nearly 1 gigawatt project on the Suffolk coast, owned by Iberdrola.

Determine if the portrayal of Scottish Power is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Scottish Power in this article on a scale from -5 to 5, where:

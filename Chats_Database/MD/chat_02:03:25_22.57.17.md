...
Analyze how Stephen Wheeler is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Added that guaranteed prices under the contracts for difference were "critical to delivering new homegrown green energy."

Determine if Stephen Wheeler's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Stephen Wheeler in this article on a scale from -5 to 5, where:
...
Person Context: Added that guaranteed prices under the contracts for difference were "critical to delivering new homegrown green energy."

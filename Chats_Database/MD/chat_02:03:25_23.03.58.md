...
Analyze how Prysmian is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in the context of abandoning a project in the U.S. due to new energy policies.

Determine if the portrayal of Prysmian is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Prysmian in this article on a scale from -5 to 5, where:

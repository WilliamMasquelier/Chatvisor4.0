...
Analyze how TotalEnergies is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed as a French oil super major considering a shift in its primary stock exchange listing due to valuation disparities.

Determine if the portrayal of TotalEnergies is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards TotalEnergies in this article on a scale from -5 to 5, where:

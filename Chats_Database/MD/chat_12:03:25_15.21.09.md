...
Analyze how Wheatbelt Storage Project is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A smaller storage project in WA's Wheatbelt region that is part of Shell's renewable energy pipeline.

Determine if the portrayal of Wheatbelt Storage Project is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Wheatbelt Storage Project in this article on a scale from -5 to 5, where:

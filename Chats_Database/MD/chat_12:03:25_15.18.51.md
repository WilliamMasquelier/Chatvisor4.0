...
Analyze how Seek AI is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in the context of AI agents assisting in workplace scheduling and assessments.

Determine if the portrayal of Seek AI is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Seek AI in this article on a scale from -5 to 5, where:

...
Analyze how WEC Turmbau Emden is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Former subsidiary of Enercon, now part of the Bettels-Gruppe, involved in tower construction.

Determine if the portrayal of WEC Turmbau Emden is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards WEC Turmbau Emden in this article on a scale from -5 to 5, where:

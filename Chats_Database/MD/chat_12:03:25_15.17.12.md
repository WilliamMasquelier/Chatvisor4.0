...
Analyze how Prelude is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Shell's floating LNG project off northern Australia, mentioned as part of Shell's energy operations.

Determine if the portrayal of Prelude is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Prelude in this article on a scale from -5 to 5, where:

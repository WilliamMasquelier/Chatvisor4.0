...
Analyze how National Grid PLC is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in relation to addressing grid constraints that may affect offshore wind projects.

Determine if the portrayal of National Grid PLC is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards National Grid PLC in this article on a scale from -5 to 5, where:

...
Analyze how PGE is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Polish company involved in the offshore wind farm project Baltica 2 in the Baltic Sea.

Determine if the portrayal of PGE is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards PGE in this article on a scale from -5 to 5, where:

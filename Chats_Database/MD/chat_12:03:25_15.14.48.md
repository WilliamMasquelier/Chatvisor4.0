...
Analyze how Ric Charlton is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Accompanied Keating to Tokyo to discuss the North West Shelf project with Japanese bankers and gas buyers.

Determine if Ric Charlton's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Ric Charlton in this article on a scale from -5 to 5, where:
...
Person Context: Accompanied Keating to Tokyo to discuss the North West Shelf project with Japanese bankers and gas buyers.

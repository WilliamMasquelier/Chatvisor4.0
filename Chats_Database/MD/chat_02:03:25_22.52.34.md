...
Analyze how Johanna Grad is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discusses efforts to reduce CO2 emissions in concrete production and the development of a new concrete recipe.

Determine if Johanna Grad's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Johanna Grad in this article on a scale from -5 to 5, where:
...
Person Context: Discusses efforts to reduce CO2 emissions in concrete production and the development of a new concrete recipe.

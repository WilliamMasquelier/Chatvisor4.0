...
Analyze how BAE Systems PLC is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Partnering with Rolls-Royce for the supply of naval systems.

Determine if the portrayal of BAE Systems PLC is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards BAE Systems PLC in this article on a scale from -5 to 5, where:

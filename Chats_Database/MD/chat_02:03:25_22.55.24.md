...
Analyze how Aslef is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Union involved in negotiations for train drivers' pay rise.

Determine if the portrayal of Aslef is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Aslef in this article on a scale from -5 to 5, where:

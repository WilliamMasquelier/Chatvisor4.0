...
Analyze how Sally Hansen is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Brand of nail products mentioned for offering nail polishes free from harmful chemicals.

Determine if the portrayal of Sally Hansen is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Sally Hansen in this article on a scale from -5 to 5, where:

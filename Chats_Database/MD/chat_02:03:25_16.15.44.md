...
Analyze how Kamer van Koophandel is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in the context of the increase in the number of nail salons in Amsterdam.

Determine if the portrayal of Kamer van Koophandel is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Kamer van Koophandel in this article on a scale from -5 to 5, where:

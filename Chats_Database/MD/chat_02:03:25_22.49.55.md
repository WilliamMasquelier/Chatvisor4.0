...
Analyze how Joe Biden is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: The Biden administration's efforts to approve offshore wind energy projects are discussed, highlighting the administration's goals for clean energy.

Determine if Joe Biden's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Joe Biden in this article on a scale from -5 to 5, where:
...
Person Context: The Biden administration's efforts to approve offshore wind energy projects are discussed, highlighting the administration's goals for clean energy.

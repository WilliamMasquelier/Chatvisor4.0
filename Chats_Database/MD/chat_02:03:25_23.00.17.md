...
Analyze how Ocean Health is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Initiative by Ørsted and Van Oord aimed at restoring oyster reefs in the North Sea.

Determine if the portrayal of Ocean Health is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Ocean Health in this article on a scale from -5 to 5, where:

...
Analyze how NSC is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Political party involved in a motion to reduce risks for energy companies in the tender process.

Determine if the portrayal of NSC is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards NSC in this article on a scale from -5 to 5, where:

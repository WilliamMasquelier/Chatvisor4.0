...
**TYPE**: Company  
**DESCRIPTION**: Top performer in the FTSE 100, reporting significant gains and increased dividends.

**ENTITY**: Starbucks Corp  
**TYPE**: Company  
**DESCRIPTION**: Discussed in relation to a large executive pay package for its new CEO.

**ENTITY**: H&M  
**TYPE**: Company  
**DESCRIPTION**: Mentioned as one of the global brands affected by political unrest in Bangladesh.
...
**TYPE**: Company  
**DESCRIPTION**: Proposed merger with Three UK discussed as necessary for investment.

**ENTITY**: Three UK  
**TYPE**: Company  
**DESCRIPTION**: Proposed merger with Vodafone discussed due to financial losses.

**ENTITY**: Rolls-Royce Holdings PLC  
**TYPE**: Company  
**DESCRIPTION**: Awarded a contract to supply systems for the Royal Navy's frigates.

**ENTITY**: BAE Systems PLC  
**TYPE**: Company  
**DESCRIPTION**: Partnering with Rolls-Royce for the supply of naval systems.

**ENTITY**: Rank Group PLC  
**TYPE**: Company  
**DESCRIPTION**: Reported a return to profit due to a rebound in London casinos.

**ENTITY**: Tata Steel  
**TYPE**: Company  
**DESCRIPTION**: Discussed in relation to government funding for workers affected by plant closures.

**ENTITY**: Deutsche Bank  
**TYPE**: Company  
**DESCRIPTION**: Provided analysis on the UK economic outlook based on GDP data.

**ENTITY**: Investec  
**TYPE**: Company  
**DESCRIPTION**: Provided commentary on the UK economic situation and growth prospects.

**ENTITY**: Office for National Statistics  
**TYPE**: Government Agency  
**DESCRIPTION**: Source of GDP data discussed in the article.

**ENTITY**: Aslef  
**TYPE**: Union  
**DESCRIPTION**: Union involved in negotiations for train drivers' pay rise.

**ENTITY**: Proactive UK Ltd  
**TYPE**: Company  

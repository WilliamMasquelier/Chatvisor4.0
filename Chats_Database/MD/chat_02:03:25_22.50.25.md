...
Analyze how Elia Group is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed as a Belgian holding for transmission system operators collaborating on hybrid offshore projects.

Determine if the portrayal of Elia Group is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Elia Group in this article on a scale from -5 to 5, where:

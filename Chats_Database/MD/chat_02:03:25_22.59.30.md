...
Analyze how Van Oord is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Collaborating with Ørsted on the Ocean Health project to reintroduce European flat oysters in the North Sea.

Determine if the portrayal of Van Oord is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Van Oord in this article on a scale from -5 to 5, where:

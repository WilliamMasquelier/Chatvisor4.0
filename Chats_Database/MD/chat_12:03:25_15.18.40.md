...
Analyze how Jensen Huang is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discussed as the primary subject of the article, highlighting his wealth increase and the impact of AI on Nvidia's stock performance.

Determine if Jensen Huang's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Jensen Huang in this article on a scale from -5 to 5, where:
...
Person Context: Discussed as the primary subject of the article, highlighting his wealth increase and the impact of AI on Nvidia's stock performance.

...
Analyze how Santos is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in relation to the Barossa gas project and its litigation over Indigenous consultation.

Determine if the portrayal of Santos is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Santos in this article on a scale from -5 to 5, where:

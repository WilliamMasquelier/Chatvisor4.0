...
Analyze how Openbaar Ministerie is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Involved in the investigation of a shooting incident related to a controversial businessman.

Determine if the portrayal of Openbaar Ministerie is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Openbaar Ministerie in this article on a scale from -5 to 5, where:

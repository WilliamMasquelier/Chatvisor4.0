...
**ENTITY**: Equinor  
**TYPE**: Company  
**DESCRIPTION**: Acquires a 9.8% stake in offshore wind company Ørsted.

**ENTITY**: SSE  
**TYPE**: Company  
**DESCRIPTION**: Wins contracts in the latest green energy auction alongside Ørsted and ScottishPower.

**ENTITY**: ScottishPower  
**TYPE**: Company  
**DESCRIPTION**: Wins contracts in the latest green energy auction alongside Ørsted and SSE.

**ENTITY**: Stonepeak  
**TYPE**: Company  
**DESCRIPTION**: Acquires Ørsted's stake in US onshore wind farms in a USD300m deal.

**ENTITY**: Vestas  
**TYPE**: Company  
**DESCRIPTION**: Mentioned as part of wind energy firms alongside Ørsted and Siemens.

**ENTITY**: Shell  
**TYPE**: Company  
**DESCRIPTION**: CEO to lead Ørsted in the US.

**ENTITY**: Brookfield  
**TYPE**: Company  
**DESCRIPTION**: Bought a stake in Ørsted UK Wind Farms for $2.3 billion.

**ENTITY**: Engie  
**TYPE**: Company  
**DESCRIPTION**: Acquires Ørsted's business in France.

**ENTITY**: MT Group  
**TYPE**: Company  
**DESCRIPTION**: To build a CO2 capture facility for Ørsted.

**ENTITY**: Great British Energy  
**TYPE**: Company  
**DESCRIPTION**: Can become a major power generator, as stated by its chair.

**ENTITY**: London Stock Exchange  
**TYPE**: Financial Institution  
**DESCRIPTION**: Regulatory news service mentioned in the context of Ørsted's financial activities. 

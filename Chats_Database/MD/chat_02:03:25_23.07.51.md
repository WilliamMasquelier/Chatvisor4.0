...
Analyze how SSE is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Wins contracts in the latest green energy auction alongside Ørsted and ScottishPower.

Determine if the portrayal of SSE is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards SSE in this article on a scale from -5 to 5, where:

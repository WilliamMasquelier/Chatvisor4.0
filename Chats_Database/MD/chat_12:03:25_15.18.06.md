...
Analyze how Microsoft is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned in the context of providing tailored enterprise AI products like Copilot.

Determine if the portrayal of Microsoft is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Microsoft in this article on a scale from -5 to 5, where:

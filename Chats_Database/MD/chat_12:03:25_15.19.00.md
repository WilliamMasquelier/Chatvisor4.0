...
Analyze how Grant Wright is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Shares a similar view on AI agents helping in the workplace.

Determine if Grant Wright's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Grant Wright in this article on a scale from -5 to 5, where:
...
Person Context: Shares a similar view on AI agents helping in the workplace.

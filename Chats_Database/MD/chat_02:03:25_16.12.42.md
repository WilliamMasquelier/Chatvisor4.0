...
Analyze how Daisy Heyer-Markos is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: The main subject of the article, discussing her allergy to gel nails and the implications of using such products.

Determine if Daisy Heyer-Markos's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Daisy Heyer-Markos in this article on a scale from -5 to 5, where:
...
Person Context: The main subject of the article, discussing her allergy to gel nails and the implications of using such products.

...
Analyze how Arrow Energy is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed as the main entity expanding the Surat Gas Project in Queensland to meet growing gas demand.

Determine if the portrayal of Arrow Energy is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Arrow Energy in this article on a scale from -5 to 5, where:

...
Analyze how Richard Hunter is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Agreed to step down with immediate effect due to the company's need for "new and different capabilities."

Determine if Richard Hunter's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Richard Hunter in this article on a scale from -5 to 5, where:
...
Person Context: Agreed to step down with immediate effect due to the company's need for "new and different capabilities."

...
Analyze how Investec is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Provided commentary on the UK economic situation and growth prospects.

Determine if the portrayal of Investec is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Investec in this article on a scale from -5 to 5, where:

...
Analyze how Cisco is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Conducted a global AI readiness report, discussing the adoption of AI technology in Australia. (Note: Excluded from final output as per instructions.)

Determine if the portrayal of Cisco is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Cisco in this article on a scale from -5 to 5, where:

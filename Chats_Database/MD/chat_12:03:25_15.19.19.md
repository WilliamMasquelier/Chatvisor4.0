...
Analyze how QGC is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Division of a London-based oil and gas giant, involved in a 27-year sales deal with Arrow for gas supply.

Determine if the portrayal of QGC is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards QGC in this article on a scale from -5 to 5, where:

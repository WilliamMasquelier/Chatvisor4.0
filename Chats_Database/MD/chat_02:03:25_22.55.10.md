...
Analyze how Rolls-Royce Holdings PLC is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Awarded a contract to supply systems for the Royal Navy's frigates.

Determine if the portrayal of Rolls-Royce Holdings PLC is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Rolls-Royce Holdings PLC in this article on a scale from -5 to 5, where:

...
Analyze how Wael Sawan is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Announced a reduction in Shell's climate targets and discussed the uncertainty in the energy transition trajectory.

Determine if Wael Sawan's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Wael Sawan in this article on a scale from -5 to 5, where:
...
Person Context: Announced a reduction in Shell's climate targets and discussed the uncertainty in the energy transition trajectory.

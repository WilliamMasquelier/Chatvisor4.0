...
Analyze how Pioneer Natural Resources is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in the context of being acquired by Exxon for $60 billion.

Determine if the portrayal of Pioneer Natural Resources is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Pioneer Natural Resources in this article on a scale from -5 to 5, where:

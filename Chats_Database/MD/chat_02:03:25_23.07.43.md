...
Analyze how Sophie Hermans is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Sets the conditions for the tenders, which are criticized by industry leaders.

Determine if Sophie Hermans's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Sophie Hermans in this article on a scale from -5 to 5, where:
...
Person Context: Sets the conditions for the tenders, which are criticized by industry leaders.

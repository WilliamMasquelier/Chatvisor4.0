...
Analyze how Australian Institute of Marine Science is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Partnered with La Trobe University to create an AI-powered digital twin of the Great Barrier Reef.

Determine if the portrayal of Australian Institute of Marine Science is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Australian Institute of Marine Science in this article on a scale from -5 to 5, where:

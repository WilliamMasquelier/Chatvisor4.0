...
Analyze how National Grid is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as the system operating wing responsible for overseeing the allocation of funds for offshore wind projects.

Determine if the portrayal of National Grid is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards National Grid in this article on a scale from -5 to 5, where:

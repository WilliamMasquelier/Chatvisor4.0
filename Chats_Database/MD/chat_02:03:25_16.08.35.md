...
**TYPE**: Institution  
**DESCRIPTION**: Mentioned as the affiliation of dermatologist-allergologist Thomas Rustemeyer, discussing risks associated with gel nails.

**ENTITY**: RIVM  
**TYPE**: Government Agency  
**DESCRIPTION**: Toxicologist Hester Hendriks is affiliated with RIVM, providing insights on acrylates in nail products.

**ENTITY**: Europese Cosmeticaverordening  
**TYPE**: Regulation  
**DESCRIPTION**: Discussed in the context of safety regulations for nail products sold in the Netherlands.

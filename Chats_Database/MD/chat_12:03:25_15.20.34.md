...
Analyze how Skye Glenday is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Releases a statement about Climate Friendly's purpose and the impact of investments on the company's growth.

Determine if Skye Glenday's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Skye Glenday in this article on a scale from -5 to 5, where:
...
Person Context: Releases a statement about Climate Friendly's purpose and the impact of investments on the company's growth.

...
Analyze how Microsoft Corporation is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Highlighted as the world's biggest software provider losing market share in China and facing challenges from local alternatives.

Determine if the portrayal of Microsoft Corporation is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Microsoft Corporation in this article on a scale from -5 to 5, where:

...
Analyze how Gary Wyatt is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discusses Shell's investment in Corporate Carbon and the role of carbon credits in climate policy.

Determine if Gary Wyatt's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Gary Wyatt in this article on a scale from -5 to 5, where:
...
Person Context: Discusses Shell's investment in Corporate Carbon and the role of carbon credits in climate policy.

...
Analyze how Trevor Brown is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discussed Omega's drilling plans and the potential for development in the Taroom Trough.

Determine if Trevor Brown's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Trevor Brown in this article on a scale from -5 to 5, where:
...
Person Context: Discussed Omega's drilling plans and the potential for development in the Taroom Trough.

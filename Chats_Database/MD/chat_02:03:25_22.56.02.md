...
Analyze how Shell is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Energy major that halted construction of a new plant in Rotterdam for converting waste into jet fuel and biodiesel.

Determine if the portrayal of Shell is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Shell in this article on a scale from -5 to 5, where:

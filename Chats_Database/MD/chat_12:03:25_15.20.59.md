...
Analyze how Garry Kasparov is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Mentioned as the opponent of the Deep Blue chess program, which is an example of a virtuoso-level narrow AI system.

Determine if Garry Kasparov's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Garry Kasparov in this article on a scale from -5 to 5, where:
...
Person Context: Mentioned as the opponent of the Deep Blue chess program, which is an example of a virtuoso-level narrow AI system.

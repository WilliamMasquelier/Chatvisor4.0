...
Analyze how Yannick Kramm is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discusses Vestas' investment in Modvion and the significance of wooden towers in the market.

Determine if Yannick Kramm's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Yannick Kramm in this article on a scale from -5 to 5, where:
...
Person Context: Discusses Vestas' investment in Modvion and the significance of wooden towers in the market.

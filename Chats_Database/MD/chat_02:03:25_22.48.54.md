...
Analyze how Ørsted A/S is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as the flagship of the green energy sector, reporting a net loss and announcing no dividend payouts for the year.

Determine if the portrayal of Ørsted A/S is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Ørsted A/S in this article on a scale from -5 to 5, where:

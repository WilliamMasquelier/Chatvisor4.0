...
Analyze how Strabag is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A construction company involved in a legal conflict in Russia, mentioned in relation to Raiffeisen.

Determine if the portrayal of Strabag is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Strabag in this article on a scale from -5 to 5, where:

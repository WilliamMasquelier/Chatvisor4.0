...
Analyze how Great British Energy is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: A new public enterprise to be created for decarbonized energy projects in the UK.

Determine if the portrayal of Great British Energy is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Great British Energy in this article on a scale from -5 to 5, where:

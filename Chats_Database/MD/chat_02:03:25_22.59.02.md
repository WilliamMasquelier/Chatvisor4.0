...
Analyze how Norvégien is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Refers to the Norwegian government, which holds a significant stake in Equinor.

Determine if the portrayal of Norvégien is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Norvégien in this article on a scale from -5 to 5, where:

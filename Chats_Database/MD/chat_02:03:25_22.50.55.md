...
Analyze how ASML is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as a tech giant concerned about potential restrictions on foreign knowledge workers.

Determine if the portrayal of ASML is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards ASML in this article on a scale from -5 to 5, where:

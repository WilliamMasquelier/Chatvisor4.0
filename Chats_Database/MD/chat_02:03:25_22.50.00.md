...
Analyze how Salt River Project is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Local utility in Arizona collaborating with Ørsted on the Eleven Mile Solar Center and transitioning to renewable energies.

Determine if the portrayal of Salt River Project is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Salt River Project in this article on a scale from -5 to 5, where:

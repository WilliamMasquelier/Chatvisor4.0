...
Analyze how Megahome is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed in the context of a significant bankruptcy affecting its owner.

Determine if the portrayal of Megahome is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Megahome in this article on a scale from -5 to 5, where:

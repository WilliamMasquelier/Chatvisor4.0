...
Analyze how Bram Wiertz is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discussed the impact of alcohol on social interactions.

Determine if Bram Wiertz's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Bram Wiertz in this article on a scale from -5 to 5, where:
...
Person Context: Discussed the impact of alcohol on social interactions.

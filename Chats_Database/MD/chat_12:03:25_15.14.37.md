...
Analyze how Andrew "Twiggy" Forrest is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Mentioned by Keating as one of the few outward-looking entrepreneurs in the modern Australian economy.

Determine if Andrew "Twiggy" Forrest's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Andrew "Twiggy" Forrest in this article on a scale from -5 to 5, where:
...
Person Context: Mentioned by Keating as one of the few outward-looking entrepreneurs in the modern Australian economy.

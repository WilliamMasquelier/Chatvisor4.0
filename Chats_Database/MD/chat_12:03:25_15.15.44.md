...
Analyze how BP is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Mentioned as a UK oil major that has analyzed the possibility of shifting its primary stock exchange listing but stated it is not on its agenda.

Determine if the portrayal of BP is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards BP in this article on a scale from -5 to 5, where:

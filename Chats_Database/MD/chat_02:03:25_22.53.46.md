...
Analyze how Cadeler is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Company responsible for the installation of wind turbines at Borkum Riffgrund 3.

Determine if the portrayal of Cadeler is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Cadeler in this article on a scale from -5 to 5, where:

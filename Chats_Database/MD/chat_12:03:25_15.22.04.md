...
Analyze how Scott Bessent is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discussed regarding his "3-3-3" plan to increase US energy production.

Determine if Scott Bessent's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Scott Bessent in this article on a scale from -5 to 5, where:
...
Person Context: Discussed regarding his "3-3-3" plan to increase US energy production.

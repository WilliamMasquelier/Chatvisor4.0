...
Analyze how Hornsea 2 is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Another offshore windfarm with a capacity to generate electricity for 1.3 million UK homes, part of the Hornsea offshore wind zone.

Determine if the portrayal of Hornsea 2 is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Hornsea 2 in this article on a scale from -5 to 5, where:

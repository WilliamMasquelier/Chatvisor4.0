...
Analyze how Deutsche Bank is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Provided analysis on the UK economic outlook based on GDP data.

Determine if the portrayal of Deutsche Bank is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Deutsche Bank in this article on a scale from -5 to 5, where:

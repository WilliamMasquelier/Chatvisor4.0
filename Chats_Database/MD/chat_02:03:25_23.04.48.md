...
Analyze how Baltic Sea is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Location of the announced offshore wind farm project.

Determine if the portrayal of Baltic Sea is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Baltic Sea in this article on a scale from -5 to 5, where:

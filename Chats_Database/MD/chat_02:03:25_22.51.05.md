...
Analyze how Jo-Annes de Bat is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Discussed in the context of his support for the collaboration between the government and companies participating in the campaign to address labor shortages in Zeeland.

Determine if Jo-Annes de Bat's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Jo-Annes de Bat in this article on a scale from -5 to 5, where:
...
Person Context: Discussed in the context of his support for the collaboration between the government and companies participating in the campaign to address labor shortages in Zeeland.

...
Analyze how Pradeep Kumar Kathail is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Person's Context: Listed as one of the inventors of the patent for 'VERIFYING TRUST POSTURES OF HETEROGENEOUS CONFIDENTIAL COMPUTING CLUSTERS'.

Determine if Pradeep Kumar Kathail's portrayal in the provided article is "Positive", "Neutral", or "Negative".
...
Rate the sentiment towards Pradeep Kumar Kathail in this article on a scale from -5 to 5, where:
...
Person Context: Listed as one of the inventors of the patent for 'VERIFYING TRUST POSTURES OF HETEROGENEOUS CONFIDENTIAL COMPUTING CLUSTERS'.

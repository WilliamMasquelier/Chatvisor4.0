...
Analyze how East Anglia Two is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Discussed as one of the large wind farms for which ScottishPower has been offered contracts.

Determine if the portrayal of East Anglia Two is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards East Anglia Two in this article on a scale from -5 to 5, where:

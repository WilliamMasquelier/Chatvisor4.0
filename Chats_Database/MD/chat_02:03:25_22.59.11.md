...
Analyze how Orsted is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Main subject of the article, focusing on its financial challenges and strategic goals.

Determine if the portrayal of Orsted is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Orsted in this article on a scale from -5 to 5, where:

...
Analyze how Dermatologie Landegem is portrayed in this article. Consider the language used, context, and framing by the journalist.
...
Organization Context: Dermatology clinic where Dr. Sven Lanssens practices, discussing contact allergy.

Determine if the portrayal of Dermatologie Landegem is "Positive", "Neutral", or "Negative" in the article.
...
Rate the sentiment towards Dermatologie Landegem in this article on a scale from -5 to 5, where:
